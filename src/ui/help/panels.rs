    ...
    guide_text(&[
        ...
        (
            ...
            &[
                ...
                "Series helpers avg(x)/mean(x), min(x), max(x), stddev(x), and len(x) return scalars; abs/sqrt/ln/log10/sin/cos/tan/floor/ceil/round preserve scalar-vs-series shape; max2(a, b), min2(a, b), and exp(a, b) work with scalar arguments, while exp can also raise a series by a scalar.",
