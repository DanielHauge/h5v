...
pub(super) fn handle_file_watch_events(tx_events: Sender<AppEvent>, path: String) {
    thread::spawn(move || {
...
pub(super) fn handle_term_events(tx_events: Sender<AppEvent>, paused: Arc<RwLock<()>>) {
