...
fn default_config_contents() -> String {
    let mut lines = vec![
        ...
        "-- Chart axis labels are shared by preview and multichart.".to_string(),
        "-- h5v.chart = { axis_numbers = \"auto\", scientific_lower_exponent = -3, scientific_upper_exponent = 5 }".to_string(),
...
fn lua_ls_stub_contents() -> Result<String, ConfigureErrors> {
    ...
    let mut lines = vec![
        ...
        "---@alias H5vAxisNumberFormat \"exact\"|\"auto\"|\"scientific\"".to_string(),
        "---@class H5vChartConfig".to_string(),
        "---@field axis_numbers H5vAxisNumberFormat".to_string(),
        "---@field scientific_lower_exponent integer".to_string(),
        "---@field scientific_upper_exponent integer".to_string(),
