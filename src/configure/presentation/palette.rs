    ...
    fn dark() -> Self {
        Self {
            ...
            mchart: MchartColors {
                ...
                item_named: Color::Rgb(136, 200, 230),
                item_id: Color::Rgb(255, 204, 0),
    ...
    fn light() -> Self {
        Self {
            text: TextColors {
                ...
                search_count: Color::Rgb(72, 78, 92),
                type_desc: Color::Rgb(72, 78, 92),
                line_num: Color::Rgb(112, 118, 132),
            },
            content: ContentColors {
                app_brand: Color::Rgb(30, 58, 95),
                app_version: Color::Rgb(30, 30, 30),
                help_hint: Color::Rgb(72, 78, 92),
            ...
            command: CommandColors {
                ...
                description: Color::Rgb(72, 78, 92),
                suggestion_label: Color::Rgb(72, 78, 92),
                no_match: Color::Rgb(110, 116, 130),
            ...
            file: FileColors {
                section_title: Color::Rgb(72, 78, 92),
            ...
            mchart: MchartColors {
                ...
                item_hidden: Color::Rgb(70, 75, 90),
                item_named: Color::Rgb(0, 84, 176),
                item_id: Color::Rgb(150, 82, 0),
                prefix_selected: Color::Rgb(30, 58, 95),
                prefix: Color::Rgb(55, 55, 55),
                detail_label: Color::Rgb(20, 78, 145),
                prompt_prefix: Color::Rgb(30, 58, 95),
            },
            surface: SurfaceColors {
